        ...
        <div className="about">
            <div className="container">
                ...
                >
                    <svg
                        className='first'
                        onMouseEnter={() => handleSectorHover(sectorDescriptions[1])}
                        onMouseLeave={resetActiveSector}
                ...
                >
                    <svg
                        className="second"
                        onMouseEnter={() => handleSectorHover(sectorDescriptions[2])}
                        onMouseLeave={resetActiveSector}
                        xmlns="http://www.w3.org/2000/svg"
                        width="176"
                        height="270"
                ...
                >
                    <svg
                        className="third"
                        onMouseEnter={() => handleSectorHover(sectorDescriptions[3])}
                        onMouseLeave={resetActiveSector}
                        xmlns="http://www.w3.org/2000/svg"
                        width="251"
                        height="207"
